...
public class ModificarPLU extends javax.swing.JFrame {

    /**
     * Creates new form ModificarPLU
     */
    public ModificarPLU(int numero) {
        initComponents();
    ...
    private void ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ModificarActionPerformed
        try {
            if (controlador.verificarCodigo(this.CampoCodigo.getText())) {
                ...
                JOptionPane.showMessageDialog(ModificarPLU.this, message, "Error", JOptionPane.OK_OPTION);
                limpiarCampos();
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarPLU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int num = 0;
                new ModificarPLU(num).setVisible(true);
            }
        });
    }
